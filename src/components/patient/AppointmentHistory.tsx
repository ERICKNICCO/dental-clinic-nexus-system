...
const AppointmentHistory: React.FC<AppointmentHistoryProps> = ({ patientId, isEditing = false }) => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = appointmentService.subscribeToAppointments((allAppointments) => {
  ...
  const handleUpdateAppointment = async () => {
    ...
    try {
      await appointmentService.updateAppointment(editingAppointmentId, editAppointment);
